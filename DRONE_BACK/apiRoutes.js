...
// //     res.json(data)
// //   } catch (err) {
// //     console.error('Error obteniendo drones disponibles:', err)
// //     res.status(500).json({ mensaje: 'Error obteniendo drones' })
// //   }
// // })
...
// //     res.status(500).json({ mensaje: 'Error obteniendo trayectos' })
// //   }
// // })
